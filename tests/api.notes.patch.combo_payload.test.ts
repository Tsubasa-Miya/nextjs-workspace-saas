...
describe('Notes PATCH - combo payload fields', () => {
  it('includes only provided fields and omits the rest', async () => {
    ...
    const body = { id: 'n1', title: 'T', tags: ['a', 'b'] };
    ...
    // omitted field remains undefined
